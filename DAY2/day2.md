...
## Summery
On Day 2, I learned about the practical aspects of digital design, starting with Liberty timing libraries. I now understand how standard cells are characterized for different PVT corners (Process, Voltage, Temperature) and how synthesis tools use this information to select cells based on drive strength, timing, area, and power. I explored hierarchical and flattened synthesis, learned their differences, and when to use each for optimizing designs. I studied the role of flip-flops in sequential circuits and how they help stabilize signals and avoid glitches. I learned about different reset strategies—asynchronous, synchronous, and synchronous-asynchronous—and how they affect timing and circuit behavior. I practiced writing synthesizable RTL, like multiplying by constants or powers of two, and saw how the synthesis tool maps these operations to efficient hardware. I also simulated my designs using Icarus Verilog and GTKWave to verify flip-flop behavior and reset functionality. Overall, I gained hands-on experience in RTL optimization, simulation, and synthesis, and I now understand how coding style impacts the final hardware in terms of power, performance, and area.
